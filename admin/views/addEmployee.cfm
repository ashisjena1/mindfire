							...
							<div class="card card-container">
								<cfoutput>
									<cfform class="form-horizontal" id="addNewEmployee">
										...
										<cfset VARIABLES.employeeRole=APPLICATION.adminService.getEmployeeRole()/>
										<div class="form-group">
												...
												<div class="col-sm-8">
													<select class="form-control" id="roleName" name="roleID">
															...
															<cfloop query="VARIABLES.employeeRole">
																<option value="#VARIABLES.employeeRole.roleId#">#VARIABLES.employeeRole.roleName#</option>
															</cfloop>
													</select>
												</div>
												<div class="col-sm-4"></div>
