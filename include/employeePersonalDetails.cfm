					  ...
					  <tr>
						...
						<td>
							...
							<cfif structKeyExists(URL,'id')>
								...
								<cfset VARIABLES.rollName = APPLICATION.adminService.getRollName(#employeePersonalDetails.departmentName#)/>
								<input type="hidden" id="roleNameHidden">
								<span id="editEmployeeRole">
									<select class="form-control" name="roleId">
										<cfloop query="VARIABLES.rollName">
											<cfif #VARIABLES.rollName.roleName# EQ #employeePersonalDetails.roleName#>
												<option selected value="#VARIABLES.rollName.roleId#">#VARIABLES.rollName.roleName#</option>
											<cfelse>
												<option value="#VARIABLES.rollName.roleId#">#VARIABLES.rollName.roleName#</option>
											</cfif>
										</cfloop>
									</select>
								</span>
